...
contains
  ...
  function EtKEEP2(id_keep,id,C,rho,p,V1,V2) result(Et)
    integer(kind=2), intent(in)               :: id_keep
    integer, intent(in)                       :: id
    real(8), intent(in)                       :: C
    real(8), intent(in), dimension(2)         :: rho, p
    real(8), intent(in), dimension(dimension) :: V1, V2
    real(8) :: IE, PV, KE, Et
  ...
  function EtKEEPPE2(id_keep,id,C,rho,p,V1,V2) result(Et)
    integer(kind=4), intent(in)               :: id_keep
    integer, intent(in)                       :: id
    real(8), intent(in)                       :: C
    real(8), intent(in), dimension(2)         :: rho, p
    real(8), intent(in), dimension(dimension) :: V1, V2
  ...
  function EtKEP2(id_keep,id,C,rho,p,V1,V2) result(Et)
    integer(kind=8), intent(in)               :: id_keep
    integer, intent(in)                       :: id
    real(8), intent(in)                       :: C
    real(8), intent(in), dimension(2)         :: rho, p
    real(8), intent(in), dimension(dimension) :: V1, V2
  ...
  function  EtKEEP4(id_keep,id,rho,p,V,RhoV) result(Et)
    integer(kind=2), intent(in)                 :: id_keep
    integer, intent(in)                         :: id
  ...
  function EtKEEPPE4(id_keep,id,rho,p,V,RhoV) result(Et)
    integer(kind=4), intent(in)                 :: id_keep
    integer, intent(in)                         :: id
    real(8), intent(in), dimension(4)           :: rho, p
    real(8), intent(in), dimension(4,dimension) :: V
  ...
  function EtKEP4(id_keep,id,rho,p,V,RhoV) result(Et)
    integer(kind=8), intent(in)                 :: id_keep
    integer, intent(in)                         :: id
    real(8), intent(in), dimension(4)           :: rho, p
    real(8), intent(in), dimension(4,dimension) :: V
  ...
  function  EtKEEP6(id_keep,id,rho,p,V,RhoV) result(Et)
    integer(kind=2), intent(in)                 :: id_keep
    integer, intent(in)                         :: id
  ...
  function EtKEEPPE6(id_keep,id,rho,p,V,RhoV) result(Et)
    integer(kind=4), intent(in)                 :: id_keep
    integer, intent(in)                         :: id
    real(8), intent(in), dimension(6)           :: rho, p
    real(8), intent(in), dimension(6,dimension) :: V
  ...
  function EtKEP6(id_keep,id,rho,p,V,RhoV) result(Et)
    integer(kind=8), intent(in)                 :: id_keep
    integer, intent(in)                         :: id
    real(8), intent(in), dimension(6)           :: rho, p
    real(8), intent(in), dimension(6,dimension) :: V
  ...
  function KEEP2(id,rho,p,V,Normal) result(F)
    use mod_globals, only : id_keep
    integer, intent(in)                         :: id
    real(8), intent(in), dimension(2)           :: rho, p
    real(8), intent(in), dimension(2,dimension) :: V
    real(8), intent(in), dimension(dimension+2) :: Normal
  ...
  function KEEP4(id,rho,p,V,Normal) result(F)
    use mod_globals, only : id_keep
    integer, intent(in)                         :: id
    real(8), intent(in), dimension(4)           :: rho, p
    real(8), intent(in), dimension(4,dimension) :: V
  ...
  function KEEP6(id,rho,p,V,Normal) result(F)
    use mod_globals, only : id_keep
    integer, intent(in)                         :: id
    real(8), intent(in), dimension(6)           :: rho, p
    real(8), intent(in), dimension(6,dimension) :: V
