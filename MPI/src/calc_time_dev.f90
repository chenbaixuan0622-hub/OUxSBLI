module calc_time_dev
  use cudafor
  use mod_globals, only : id_hybrid, id_muscl, id_visc, id_turbulence, nt, np, &
...
contains
  subroutine calc_EFG_basic(id_hybrid,nx,ny,nz,dx,dy,Jacobian,QJ,mut,E,F,G)
    ...
    real(8), intent(out), device                        :: E(nx-1,ny-2,nz-2,5)
  ...
  subroutine calc_EFG_hybrid(id_hybrid,nx,ny,nz,dx,dy,Jacobian,QJ,mut,E,F,G)
    ...
    real(8), dimension(nx-1,ny-2,nz-2,5), device :: E_upwind
    real(8), dimension(nx-2,ny-1,nz-2,5), device :: F_upwind
    real(8), dimension(nx-2,ny-2,nz-1,5), device :: G_upwind
    integer stat
  ...
  subroutine RungeKutta_3rd(id_RungeKutta,nx,ny,nz,x,dx_cpu,xix_cpu,y,dy_cpu,etay_cpu,z,Jacobian_cpu,Q)
    ...
    real(8), device                         :: E(nx-1,ny-2,nz-2,5)
    real(8), device                         :: F(nx-2,ny-1,nz-2,5)
    real(8), device                         :: G(nx-2,ny-2,nz-1,5)
  ...
  subroutine RungeKutta_4th(id_RungeKutta,nx,ny,nz,x,dx_cpu,xix_cpu,y,dy_cpu,etay_cpu,z,Jacobian_cpu,Q)
    ...
    real(8), device                         :: F(nx-2,ny-1,nz-2,5)
    real(8), device                         :: G(nx-2,ny-2,nz-1,5)
    real(8), device                         :: Rs(nx-2,ny-2,nz-2,5)
    real(8), dimension(nx-1), device        :: dx, xix  ! xix = 1 / dx
    real(8), dimension(ny-1), device        :: dy, etay ! etay = 1 / dy
    real(8), dimension(nx,ny), device       :: Jacobian
    ! for plot
  ...
  subroutine RungeKutta_10th(id_RungeKutta,nx,ny,nz,x,dx_cpu,xix_cpu,y,dy_cpu,etay_cpu,z,Jacobian_cpu,Q)
    ...
    real(8), device                         :: F(nx-2,ny-1,nz-2,5)
    real(8), device                         :: G(nx-2,ny-2,nz-1,5)
    real(8), device                         :: R4(nx-2,ny-2,nz-2,5)
    real(8), dimension(nx-1), device        :: dx, xix  ! xix = 1 / dx
    real(8), dimension(ny-1), device        :: dy, etay ! etay = 1 / dy
    real(8), dimension(nx,ny), device       :: Jacobian
    ! for plot
