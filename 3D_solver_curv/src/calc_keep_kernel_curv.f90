...
contains
  ...
  attributes(global) subroutine calc_keep_xi_curv(id_accuracy, nx, ny, nz, n_xi_x, n_xi_y, Q, T, E)
  ...
  attributes(global) subroutine calc_keep_eta_curv(id_accuracy, nx, ny, nz, n_eta_x, n_eta_y, Q, T, F)
    integer(2), intent(in), value               :: id_accuracy
    integer,    intent(in), value               :: nx, ny, nz
  ...
  attributes(global) subroutine calc_keep_z_curv(id_accuracy, nx, ny, nz, Q, T, G)
