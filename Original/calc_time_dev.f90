  ...
  subroutine RungeKutta(nx,ny,nz,nt,np,dx,dy,dz,dt,gamma,mu,kappa,Cp,Q)
    ...
    do t2 = 1, np
      do t1 = 1, nt
        ...
        call calc_step1(nx,ny,nz,dxi,dyi,dzi,dt,E,F,G,Q,Q2)
        ...
        call calc_F(id,nx,ny,nz,gamma,rho,u,v,w,p,F)
        call calc_G(id,nx,ny,nz,gamma,rho,u,v,w,p,G)
        call calc_step2(nx,ny,nz,dxi,dyi,dzi,dt,E,F,G,Q,Q2,Q3)
        ...
        call calc_F(id,nx,ny,nz,gamma,rho,u,v,w,p,F)
        call calc_G(id,nx,ny,nz,gamma,rho,u,v,w,p,G)
        call calc_step3(nx,ny,nz,dxi,dyi,dzi,dt,E,F,G,Q3,Q)
