module mod_globals
  ...
  integer, parameter :: nx = 2241
  integer, parameter :: ny = 545
  ...
  ! oblique shock
  real(8), parameter :: beta  = dacos(-1.d0) * 29.8d0 / 180.d0
  ...
  real(8), parameter :: beta_r = dacos(-1.d0) * 42.66d0 / 180.d0
