...
contains
  ...
  attributes(global) subroutine calc_E(nx, ny, rho, u, v, p, sensor, E)
    use mod_globals, only : id_accuracy, id_scheme
    integer, intent(in), value                    :: nx, ny
    real(8), intent(in), dimension(nx,ny), device :: rho, u, v, p, sensor
  ...
  attributes(global) subroutine calc_F(nx, ny, rho, u, v, p, sensor, F)
