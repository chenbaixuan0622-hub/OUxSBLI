...
module calc_flux_base
  use mod_globals, only : id_accuracy, id_bc_x, id_bc_y, sp, &
...
contains
  ...
  subroutine calc_EF_Euler(id_visc, nx, ny, inv_dx, inv_dy, Jacobian, QJ, Q, T, mu, E, F)
