module calc_keep_kernel_internal
  ...
  use mod_constant, only : R_over_gamma_1, one_third, one_sixth, one_twelfth, two_third, id_accuracy
  implicit none
  private
