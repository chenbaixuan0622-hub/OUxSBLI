          ...
          block
            ...
            associate(uu => u)
              E(:,i,j-1) = KEEP(id_accuracy, &
                                rho(it-2:it+3,jt), u(it-2:it+3,jt), v(it-2:it+3,jt), &
          ...
          block
            ...
            associate(uu => u)
              E(:,i,j-1) = KEEP(id_accuracy4, &
                                rho(it-1:it+2,jt), u(it-1:it+2,jt), v(it-1:it+2,jt), &
          ...
          block
            ...
            associate(uu => u)
              E(:,i,j-1) = KEEP(id_accuracy2, &
                                rho(it:it+1,jt), u(it:it+1,jt), v(it:it+1,jt), &
          ...
          block
            ...
            associate(vv => v)
              F(:,i-1,j) = KEEP(id_accuracy, &
                                rho(jt-2:jt+3,it), u(jt-2:jt+3,it), v(jt-2:jt+3,it), &
          ...
          block
            ...
            associate(vv => v)
              F(:,i-1,j) = KEEP(id_accuracy4, &
                                rho(jt-1:jt+2,it), u(jt-1:jt+2,it), v(jt-1:jt+2,it), &
          ...
          block
            ...
            associate(vv => v)
              F(:,i-1,j) = KEEP(id_accuracy2, &
                                rho(jt:jt+1,it), u(jt:jt+1,it), v(jt:jt+1,it), &
