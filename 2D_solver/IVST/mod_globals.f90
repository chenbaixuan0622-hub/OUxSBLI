module mod_globals
  ...
  ! GPU
  type(dim3) :: blocksE   = dim3((nx-accuracy+1)/128,(ny-accuracy)/1,1)
  type(dim3) :: blocksF   = dim3((nx-accuracy)/127,(ny-accuracy+1)/1,1)
  type(dim3) :: blocksEv  = dim3((nx-accuracy+1)/128,(ny-accuracy)/1,1)
  type(dim3) :: blocksFv  = dim3((nx-accuracy)/127,(ny-accuracy+1)/1,1)
  type(dim3) :: blocks    = dim3((nx-accuracy)/127,(ny-accuracy)/1,1)
