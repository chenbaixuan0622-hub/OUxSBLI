...
contains
  ...
  subroutine RungeKutta(nx,ny,nz,nt,np,dx,dy,dz,dt,gamma,mu,kappa,Cp,Q)
    ...
    !blocksE = dim3(1,(ny-accuracy)/49,(nz-accuracy)/49)
    !blocksF = dim3((nx-accuracy)/49,1,(nz-accuracy)/49)
    !blocksG = dim3((nx-accuracy)/49,(ny-accuracy)/49,1)
