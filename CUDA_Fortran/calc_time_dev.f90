...
contains
  ...
  subroutine RungeKutta(nx,ny,nz,nt,np,dx,dy,dz,dt,gamma,mu,kappa,Cp,Q)
    ...
    blocks_offset = dim3((nx-accuracy)/49,(ny-accuracy)/49,(nz-accuracy)/49)
    threads_offset = dim3(49,49,49)
    blocksE = dim3((nx-accuracy+1),(ny-accuracy)/49,(nz-accuracy)/49)
    blocksF = dim3((nx-accuracy)/49,(ny-accuracy+1),(nz-accuracy)/49)
    blocksG = dim3((nx-accuracy)/49,(ny-accuracy)/49,(nz-accuracy+1))
    threadsE = dim3(nx-accuracy+1,49,49)
    threadsF = dim3(49,ny-accuracy+1,49)
    threadsG = dim3(49,49,nz-accuracy+1)
