module calc_visc
  implicit none
contains
  attributes(global) subroutine calc_Ev(id, nx, ny, nz, dX, dY, dZ, mu, kappa, u, v, w, T, Ev)
  ...
  attributes(global) subroutine calc_Fv(id, nx, ny, nz, dX, dY, dZ, mu, kappa, u, v, w, T, Fv)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: dX, dY, dZ, mu, kappa
    real(8), intent(in), dimension(nx,ny,nz), device :: u, v, w, T
  ...
  attributes(global) subroutine calc_Gv(id, nx, ny, nz, dX, dY, dZ, mu, kappa, u, v, w, T, Gv)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: dX, dY, dZ, mu, kappa
    real(8), intent(in), dimension(nx,ny,nz), device :: u, v, w, T
