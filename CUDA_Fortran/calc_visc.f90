...
contains
  ...
  attributes(global) subroutine calc_Ev2(id, nx, ny, nz, dX, dY, dZ, mu, kappa, u, v, w, T, Ev)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: dX, dY, dZ, mu, kappa
  ...
  attributes(global) subroutine calc_Ev2_LES(id, nx, ny, nz, dX, dY, dZ, mu, kappa, delta, Cs, rho, u, v, w, T, Ev)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
  ...
  attributes(global) subroutine calc_Fv2(id, nx, ny, nz, dX, dY, dZ, mu, kappa, u, v, w, T, Fv)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: dX, dY, dZ, mu, kappa
    real(8), intent(in), dimension(nx,ny,nz), device :: u, v, w, T
  ...
  attributes(global) subroutine calc_Fv2_LES(id, nx, ny, nz, dX, dY, dZ, mu, kappa, delta, Cs, rho, u, v, w, T, Fv)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: dX, dY, dZ, mu, kappa, delta, Cs
    real(8), intent(in), dimension(nx,ny,nz), device :: rho, u, v, w, T
  ...
  attributes(global) subroutine calc_Gv2(id, nx, ny, nz, dX, dY, dZ, mu, kappa, u, v, w, T, Gv)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: dX, dY, dZ, mu, kappa
    real(8), intent(in), dimension(nx,ny,nz), device :: u, v, w, T
  ...
  attributes(global) subroutine calc_Gv2_LES(id, nx, ny, nz, dX, dY, dZ, mu, kappa, delta, Cs, rho, u, v, w, T, Gv)
    integer(kind=2), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: dX, dY, dZ, mu, kappa, delta, Cs
    real(8), intent(in), dimension(nx,ny,nz), device :: rho, u, v, w, T
