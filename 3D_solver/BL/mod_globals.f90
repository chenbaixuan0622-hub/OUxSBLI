module mod_globals
  ...
  type(dim3) :: blocksG = dim3((nx-accuracy)/1,(ny-accuracy)/5,(nz-accuracy+1)/8)
  type(dim3) :: blocks = dim3((nx-accuracy)/1,(ny-accuracy)/5,(nz-accuracy)/7)
  type(dim3) :: threadsE = dim3(32,5,1)
  type(dim3) :: threadsF = dim3(1,32,7)
  type(dim3) :: threadsG = dim3(1,5,8)
  type(dim3) :: threads = dim3(1,5,7)
  ...
  real(8), parameter :: u0 = 34.97d0
  real(8), parameter :: dt = 0.001d0 * (Lx / dble(nx-1)) / u0
  ...
  real(8), parameter :: p0 = 99303.d0
  real(8), parameter :: T0 = 294.41d0
