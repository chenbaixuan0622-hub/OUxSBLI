...
module calc_roe_kernel_internal
  use mod_globals, only : id_accuracy, gamma, threadsE, threadsF, threadsG
...
contains
  ...
  attributes(global) subroutine calc_roe_x_in(nx, ny, nz, Q, sensor, E)
  ...
  attributes(global) subroutine calc_roe_y_in(nx, ny, nz, Q, sensor, F)
    integer, intent(in), value               :: nx                  !< grid points x
    integer, intent(in), value               :: ny                  !< grid points y
    integer, intent(in), value               :: nz                  !< grid points z
    real(8), intent(in), device, contiguous  :: Q(nx,5,ny,nz)       !< conservative variables
  ...
  attributes(global) subroutine calc_roe_z_in(nx, ny, nz, Q, sensor, G)
    integer, intent(in), value               :: nx                  !< grid points x
    integer, intent(in), value               :: ny                  !< grid points y
    integer, intent(in), value               :: nz                  !< grid points z
    real(8), intent(in), device, contiguous  :: Q(nx,5,ny,nz)       !< conservative variables
