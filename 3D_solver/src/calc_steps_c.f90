...
contains
  ...
  subroutine calc_R_forcing_c(nx, ny, nz, dx_ptr, dy_ptr, dz_ptr, E_ptr, F_ptr, G_ptr, &
                              fx_ptr, fy_ptr, fz_ptr, R_ptr) bind(c, name="calc_R_forcing_c")
    integer, intent(in), value     :: nx, ny, nz
    real(8), intent(inout), target :: dx_ptr, dy_ptr, dz_ptr
    real(8), intent(inout), target :: E_ptr, F_ptr, G_ptr, fx_ptr, fy_ptr, fz_ptr, R_ptr
    real(8), dimension(:), device, pointer       :: dx, dy, dz
    real(8), dimension(:,:,:,:), device, pointer :: E, F, G, R
  ...
  subroutine calc_step_forcing_c(nx, ny, nz, coef1, coef2, dx_ptr, dy_ptr, dz_ptr, E_ptr, F_ptr, G_ptr, &
                                 fx_ptr, fy_ptr, fz_ptr, Q_ptr, Q2_ptr, Rs_ptr) bind(c, name="calc_step_forcing_c")
    integer, intent(in), value     :: nx, ny, nz
    real(8), intent(in), value     :: coef1, coef2
    real(8), intent(inout), target :: dx_ptr, dy_ptr, dz_ptr
    real(8), intent(inout), target :: E_ptr, F_ptr, G_ptr, Q_ptr, Q2_ptr, Rs_ptr, fx_ptr, fy_ptr, fz_ptr
    real(8), dimension(:), device, pointer       :: dx, dy, dz
    real(8), dimension(:,:,:,:), device, pointer :: E, F, G, Q, Q2, Rs
    real(8), dimension(:,:,:), device, pointer   :: fx, fy, fz
    call c_f_pointer(c_loc(dx_ptr), dx, [nx-1])
    ...
    call c_f_pointer(c_loc(Q2_ptr), Q2, [5,nx,ny,nz])
    call c_f_pointer(c_loc(Rs_ptr), Rs, [5,nx-2,ny-2,nz-2])
    call c_f_pointer(c_loc(fx_ptr), fx, [5,nx-2,ny-2,nz-2])
    call c_f_pointer(c_loc(fy_ptr), fy, [5,nx-2,ny-2,nz-2])
    call c_f_pointer(c_loc(fz_ptr), fz, [5,nx-2,ny-2,nz-2])
    call calc_step_forcing(nx, ny, nz, coef1, coef2, dx, dy, dz, E, F, G, fx, fy, fz, Q, Q2, Rs)
  end subroutine calc_step_forcing_c
  ...
  subroutine calc_step2_3_forcing_c(nx, ny, nz, coef1, coef2, coef3, coef4, dx_ptr, dy_ptr, dz_ptr, &
                                    E_ptr, F_ptr, G_ptr, fx_ptr, fy_ptr, fz_ptr, Qin_ptr, Qinout_ptr) bind(c, name="calc_step2_3_forcing_c")
    integer, intent(in), value     :: nx, ny, nz
    real(8), intent(in), value     :: coef1, coef2, coef3, coef4
    real(8), intent(inout), target :: dx_ptr, dy_ptr, dz_ptr
    real(8), intent(inout), target :: E_ptr, F_ptr, G_ptr, fx_ptr, fy_ptr, fz_ptr, Qin_ptr, Qinout_ptr
    real(8), dimension(:), device, pointer       :: dx, dy, dz
    real(8), dimension(:,:,:,:), device, pointer :: E, F, G, Qin, Qinout
    real(8), dimension(:,:,:), device, pointer   :: fx, fy, fz
    call c_f_pointer(c_loc(dx_ptr), dx, [nx-1])
    ...
    call c_f_pointer(c_loc(fy_ptr), fy, [nx-2,ny-2,nz-2])
    call c_f_pointer(c_loc(fz_ptr), fz, [nx-2,ny-2,nz-2])
    call calc_step2_3_forcing(nx, ny, nz, coef1, coef2, coef3, coef4, dx, dy, dz, E, F, G, fx, fy, fz, Qin, Qinout)
  end subroutine calc_step2_3_forcing_c
  ...
  subroutine calc_step4_forcing_c(nx, ny, nz, dx_ptr, dy_ptr, dz_ptr, E_ptr, F_ptr, G_ptr, &
                                  fx_ptr, fy_ptr, fz_ptr, Rs_ptr, Q_ptr) bind(c, name="calc_step4_forcing_c")
    integer, intent(in), value     :: nx, ny, nz
    real(8), intent(inout), target :: dx_ptr, dy_ptr, dz_ptr
    real(8), intent(inout), target :: E_ptr, F_ptr, G_ptr, fx_ptr, fy_ptr, fz_ptr, Rs_ptr, Q_ptr
    real(8), dimension(:), device, pointer       :: dx, dy, dz
    real(8), dimension(:,:,:,:), device, pointer :: E, F, G, Rs, Q
    real(8), dimension(:,:,:), device, pointer   :: fx, fy, fz
    call c_f_pointer(c_loc(dx_ptr), dx, [nx-1])
    ...
    call c_f_pointer(c_loc(fy_ptr), fy, [nx-2,ny-2,nz-2])
    call c_f_pointer(c_loc(fz_ptr), fz, [nx-2,ny-2,nz-2])
    call calc_step4_forcing(nx, ny, nz, dx, dy, dz, E, F, G, fx, fy, fz, Rs, Q)
  end subroutine calc_step4_forcing_c
  ...
  subroutine calc_Gauss_step_c(nx, ny, nz, a1, a2, dx_ptr, dy_ptr, dz_ptr, &
                               R1_ptr, R2_ptr, Q_ptr, Q2_ptr) bind(c, name="calc_Gauss_step_c")
    integer, intent(in), value     :: nx, ny, nz
    real(8), intent(in), value     :: a1, a2
    real(8), intent(inout), target :: dx_ptr, dy_ptr, dz_ptr, R1_ptr, R2_ptr, Q_ptr, Q2_ptr
    real(8), dimension(:), device, pointer       :: dx, dy, dz
    ...
    call c_f_pointer(c_loc(Q_ptr), Q, [5,nx,ny,nz])
    call c_f_pointer(c_loc(Q2_ptr), Q2, [5,nx,ny,nz])
    call calc_Gauss_step(nx, ny, nz, a1, a2, dx, dy, dz, R1, R2, Q, Q2)
  end subroutine calc_Gauss_step_c
  
  subroutine calc_Gauss_step_Q_c(nx, ny, nz, a1, a2, dx_ptr, dy_ptr, dz_ptr, &
                                 R1_ptr, R2_ptr, Q_ptr) bind(c, name="calc_Gauss_step_Q_c")
    integer, intent(in), value                                                    :: nx, ny, nz
    real(8), intent(in), value                                                    :: a1, a2
    real(8), intent(inout), target :: dx_ptr, dy_ptr, dz_ptr, R1_ptr, R2_ptr, Q_ptr
    real(8), dimension(:), device, pointer       :: dx, dy, dz
    ...
    call c_f_pointer(c_loc(R2_ptr), R2, [5,nx-2,ny-2,nz-2])
    call c_f_pointer(c_loc(Q_ptr), Q, [5,nx,ny,nz])
    call calc_Gauss_step_Q(nx, ny, nz, a1, a2, dx, dy, dz, R1, R2, Q)
