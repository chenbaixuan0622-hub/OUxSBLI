...
module calc_visc4_internal
  ...
  implicit none
  private
  public calc_Ev4_in, calc_Fv4_in, calc_Gv4_in, calc_Ev4_in_koff, calc_Fv4_in_koff, calc_Gv4_in_koff
...
contains
  ...
  attributes(global) subroutine calc_Ev4_in_koff(nx, ny, nz, dx, dy, dz, Q, T, mu, E, k_lo, k_hi)
  ...
  end subroutine calc_Ev4_in_koff


  attributes(global) subroutine calc_Fv4_in_koff(nx, ny, nz, dy, dx, dz, Q, T, mu, F, k_lo, k_hi)
    integer, intent(in), value                 :: nx, ny, nz
  ...
  end subroutine calc_Fv4_in_koff


  attributes(global) subroutine calc_Gv4_in_koff(nx, ny, nz, dx, dy, dz, Q, T, mu, G, k_lo, k_hi)
    integer, intent(in), value                 :: nx, ny, nz
    real(8), intent(in), device, contiguous    :: dx(nx-1), dy(ny-1), dz(nz-1)
    real(8), intent(in), device, contiguous    :: Q(nx,5,ny,nz), T(nx,ny,nz), mu(nx,ny,nz)
  ...
  end subroutine calc_Gv4_in_koff
