...
module calc_visc4_les_internal
  ...
  implicit none
  private
  public calc_Ev_LES4_in, calc_Fv_LES4_in, calc_Gv_LES4_in, calc_Ev_LES4_in_koff, calc_Fv_LES4_in_koff, calc_Gv_LES4_in_koff
...
contains
  ...
  attributes(global) subroutine calc_Ev_LES4_in_koff(nx, ny, nz, dx, dy, dz, Q, T, mu, mut, qc2, E, k_lo, k_hi)
  ...
  end subroutine calc_Ev_LES4_in_koff


  attributes(global) subroutine calc_Fv_LES4_in_koff(nx, ny, nz, dy, dx, dz, Q, T, mu, mut, qc2, F, k_lo, k_hi)
    integer, intent(in), value                 :: nx
    integer, intent(in), value                 :: ny
    integer, intent(in), value                 :: nz
    real(8), intent(in), device, contiguous    :: dy(ny-1)
  ...
  end subroutine calc_Fv_LES4_in_koff


  attributes(global) subroutine calc_Gv_LES4_in_koff(nx, ny, nz, dx, dy, dz, Q, T, mu, mut, qc2, G, k_lo, k_hi)
    integer, intent(in), value                 :: nx, ny, nz
    real(8), intent(in), device, contiguous    :: dx(nx-1), dy(ny-1), dz(nz-1)
    real(8), intent(in), device, contiguous    :: Q(nx,5,ny,nz), T(nx,ny,nz), mu(nx,ny,nz)
  ...
  end subroutine calc_Gv_LES4_in_koff
