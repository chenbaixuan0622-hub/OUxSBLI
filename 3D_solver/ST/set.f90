...
contains
  ...
  subroutine set_bc(nx,ny,nz,Jacobian,Q)
    ...
    do l = 1, 5
      do i = 3, nx-2
        Q(i,1,1,l) = Q(i,ny-3,nz-3,l)
        Q(i,1,2,l) = Q(i,ny-3,nz-2,l)
        Q(i,2,1,l) = Q(i,ny-2,nz-3,l)
        Q(i,2,2,l) = Q(i,ny-2,nz-2,l)

        Q(i,ny-1,1,l) = Q(i,3,nz-3,l)
        Q(i,ny-1,2,l) = Q(i,3,nz-2,l)
        Q(i,ny,1,l)   = Q(i,4,nz-3,l)
        Q(i,ny,2,l)   = Q(i,4,nz-2,l)

        Q(i,1,nz-1,l) = Q(i,ny-3,3,l)
        Q(i,1,nz,l)   = Q(i,ny-3,4,l)
        Q(i,2,nz-1,l) = Q(i,ny-2,3,l)
        Q(i,2,nz,l)   = Q(i,ny-2,4,l)

        Q(i,ny-1,nz-1,l) = Q(i,3,3,l)
        Q(i,ny-1,nz,l)   = Q(i,3,4,l)
        Q(i,ny,nz-1,l)   = Q(i,4,3,l)
        Q(i,ny,nz,l)     = Q(i,4,4,l)
    enddo;enddo
