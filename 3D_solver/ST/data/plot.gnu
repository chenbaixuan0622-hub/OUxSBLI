...
set mxtics 5
set mytics 5
plot datafile using 1:3 with lines lw 2 lc rgb "blue"

set ylabel "{/=12 {/Times-New-Roman:Italic P}}"
set size square
set mxtics 5
set mytics 5
plot datafile using 1:4 with lines lw 2 lc rgb "blue"

set ylabel "{/=12 {/Times-New-Roman:Italic T}}"
set size square
set mxtics 5
set mytics 5
plot datafile using 1:5 with lines lw 2 lc rgb "blue"

set ylabel "{/=12 {/Times-New-Roman:Italic M}}"
set size square
set mxtics 5
set mytics 5
plot datafile using 1:6 with lines lw 2 lc rgb "blue"

set ylabel "{/=12 {/Symbol:Italic m}}"
set size square
set mxtics 5
set mytics 5
plot datafile using 1:7 with lines lw 2 lc rgb "blue"
