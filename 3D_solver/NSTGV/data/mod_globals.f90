module mod_globals
  ...
  integer(kind=4), parameter :: id_visc   = 2
  ...
  integer, parameter :: nx = 130!66!258
  integer, parameter :: ny = 130!66!258
  integer, parameter :: nz = 130!66!258

  integer, parameter :: nre = nx-4

  ! GPU
  type(dim3) :: blocksE = dim3((nx-accuracy+1)/1,(ny-accuracy)/8,(nz-accuracy)/8)
  type(dim3) :: blocksF = dim3((nx-accuracy)/16,(ny-accuracy+1)/1,(nz-accuracy)/8)
  type(dim3) :: blocksG = dim3((nx-accuracy)/16,(ny-accuracy)/8,(nz-accuracy+1)/1)
  type(dim3) :: blocks  = dim3((nx-accuracy)/16,(ny-accuracy)/8,(nz-accuracy)/8)
  type(dim3) :: threadsE = dim3(1,8,8)
  type(dim3) :: threadsF = dim3(16,1,8)
  type(dim3) :: threadsG = dim3(16,8,1)
  type(dim3) :: threads  = dim3(16,8,8)
