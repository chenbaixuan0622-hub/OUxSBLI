module mod_globals
  ...
  type(dim3) :: blocksF   = dim3((nx-accuracy)/51,(ny-accuracy+1)/1,(nz-accuracy)/1)
  type(dim3) :: blocksG   = dim3((nx-accuracy)/51,(ny-accuracy)/1,(nz-accuracy+1)/1)
  type(dim3) :: blocksEv  = dim3((nx-accuracy+1)/128,(ny-accuracy)/1,(nz-accuracy)/1)
  type(dim3) :: blocksFv  = dim3((nx-accuracy)/51,(ny-accuracy+1)/1,(nz-accuracy)/1)
  type(dim3) :: blocksGv  = dim3((nx-accuracy)/51,(ny-accuracy)/1,(nz-accuracy+1)/1)
  type(dim3) :: blocks    = dim3((nx-accuracy)/51,(ny-accuracy)/1,(nz-accuracy)/1)
  type(dim3) :: threadsE  = dim3(128,1,1)
  type(dim3) :: threadsF  = dim3(51,1,1)
  type(dim3) :: threadsG  = dim3(51,1,1)
  type(dim3) :: threadsEv = dim3(128,1,1)
  type(dim3) :: threadsFv = dim3(51,1,1)
  type(dim3) :: threadsGv = dim3(51,1,1)
  type(dim3) :: threads   = dim3(51,1,1)
