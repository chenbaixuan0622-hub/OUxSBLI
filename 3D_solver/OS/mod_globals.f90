module mod_globals
  ...
  type(dim3) :: blocksF  = dim3((nx-accuracy)/7,(ny-accuracy+1)/32,(nz-accuracy)/1)
  type(dim3) :: blocksG  = dim3((nx-accuracy)/73,(ny-accuracy)/5,(nz-accuracy+1)/1)
  ...
  type(dim3) :: threadsG = dim3(73,5,1)
