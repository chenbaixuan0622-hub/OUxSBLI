...
contains
  ...
  attributes(global) subroutine calc_E4(id, nx, ny, nz, gamma, rho, u, v, w, p, E)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  attributes(global) subroutine calc_F4(id, nx, ny, nz, gamma, rho, u, v, w, p, F)
    integer(kind=4), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: gamma
    real(8), intent(in), dimension(nx,ny,nz), device :: rho, u, v, w, p
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  attributes(global) subroutine calc_G4(id, nx, ny, nz, gamma, rho, u, v, w, p, G)
    integer(kind=4), intent(in), value :: id
    integer, intent(in), value :: nx, ny, nz
    real(8), intent(in), value :: gamma
    real(8), intent(in), dimension(nx,ny,nz), device :: rho, u, v, w, p
