...
contains
  ...
  subroutine set_blocks_threads(myrank,nx,ny,nz,blocksE,blocksF,blocksG,blocks,threadsE,threadsF,threadsG,threads)
    ...
    elseif (myrank == 2) then
      ...
      blocksF  = dim3((nx-accuracy)/11,(ny-accuracy+1)/32,(nz-accuracy)/1)
      blocksG  = dim3((nx-accuracy)/11,(ny-accuracy)/1,(nz-accuracy+1)/32)
      blocks   = dim3((nx-accuracy)/11,(ny-accuracy)/3,(nz-accuracy)/1)
      threadsE = dim3(32,3,1)
      threadsF = dim3(11,32,1)
      threadsG = dim3(11,1,32)
      threads  = dim3(11,3,1)
    endif
