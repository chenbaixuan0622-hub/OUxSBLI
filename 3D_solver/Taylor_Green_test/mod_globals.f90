module mod_globals
  ...
  ! GPU
  type(dim3) :: blocksE = dim3((nx-accuracy+1)/32,(ny-accuracy)/3,(nz-accuracy)/3)
  type(dim3) :: blocksF = dim3((nx-accuracy)/3,(ny-accuracy+1)/32,(nz-accuracy)/3)
  type(dim3) :: blocksG = dim3((nx-accuracy)/3,(ny-accuracy)/3,(nz-accuracy+1)/32)
  type(dim3) :: threadsE = dim3(32,3,3)
  type(dim3) :: threadsF = dim3(3,32,3)
  type(dim3) :: threadsG = dim3(3,3,32)
